...
// =============================================================================
// LogoutButton — POSTs to /api/auth/logout (which clears the cookie), then
// hard-routes to /login and refreshes the router cache so no stale
// authenticated UI lingers.
// =============================================================================
...
export type { LogoutButtonProps } from "./types";
